...
const SIDEBAR = {
  ...
  LABEL_DARK_MODE: COMMON.LABEL_DARK_MODE,
  SWITCH_THEME_ARIA_LABEL: COMMON.SWITCH_THEME_ARIA_LABEL,
  BTN_LOGIN_TEXT: COMMON.BTN_LOGIN_TEXT,
  BTN_LOGIN_ARIA_LABEL: COMMON.BTN_LOGIN_ARIA_LABEL,
  BTN_LOGOUT_TEXT: COMMON.BTN_LOGOUT_TEXT,
  BTN_LOGOUT_ARIA_LABEL: COMMON.BTN_LOGOUT_ARIA_LABEL,
} as const;
...
const HEADER = {
  ...
  BADGE_DEFAULT_USER: COMMON.BADGE_DEFAULT_USER,
  BTN_LOGIN_TEXT: COMMON.BTN_LOGIN_TEXT,
  BTN_LOGIN_ARIA_LABEL: COMMON.BTN_LOGIN_ARIA_LABEL,
  BTN_LOGOUT_TEXT: COMMON.BTN_LOGOUT_TEXT,
  BTN_LOGOUT_ARIA_LABEL: COMMON.BTN_LOGOUT_ARIA_LABEL,
...
const MICROSOFT = {
  ...
  CAT_DEVICE: 'Device',
  CAT_DEVICE_DESC: 'MDE driven',
  CAT_IDENTITIES: 'Identities',
  CAT_IDENTITIES_DESC: 'from Entra',
  CAT_APPS: 'Apps',
  CAT_APPS_DESC: 'Defender for Cloud Apps',
  CAT_DATA: 'Data',
  CAT_DATA_DESC: 'governance through Purview',
