...
export const APP_STRINGS = {
  ...
  VIEWS: {
    ...
    MICROSOFT: {
      ...
      NAV_HASH: '#microsoft',
      HEADING_PAGE: 'Microsoft Security Operations & MSRC Radar',
      TXT_DESCRIPTION: 'Unified Microsoft Defender incident triage and MSRC vulnerability intelligence hub.',
      TAB_DEFENDER: 'Defender Incident Triage',
      TAB_MSRC: 'MSRC CVE Radar',
      HEADING_KPI_ACTIVE: 'Active Incidents',
      HEADING_KPI_CRITICAL: 'High / Critical Alerts',
      HEADING_KPI_RESOLVED: 'Resolved Incidents',
      HEADING_KPI_TOTAL: 'Total Telemetry Signals',
      BTN_SIMULATE_ALERT: 'Simulate Threat Signal',
      BTN_EXPORT_SENTINEL: 'Export to Sentinel (JSON)',
      BTN_FILTER_ALL: 'All Severities',
      LABEL_FILTER_STATUS: 'Filter Status',
      INPUT_SEARCH_CVES: 'Search CVEs by ID, affected product, or keywords...',
      TXT_NO_INCIDENTS: 'No security incidents found matching current filters.',
      TXT_NO_CVES: 'No Microsoft CVE advisories found matching search query.',
      TXT_ZERO_DAY_BADGE: '0-Day Active',
      TXT_EXPORT_SUCCESS: 'Sentinel incident bundle exported successfully',
